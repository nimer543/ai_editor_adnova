"""
Django settings for ai_ideator_project project.
...
SECRET_KEY = 'django-insecure-ve^a!4=kw1b08_^sbfps8%)8tboymes-87i1e67%=u&f%258zm'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['adnova.onrender.com', 'localhost', '127.0.0.1']
